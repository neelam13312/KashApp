...
public class JodiFamilyFragment extends Fragment implements View.OnClickListener {
    ...
    TextView tv;
    String market_status,title,betdate,w_amount="",bettype,s_time ,e_time,matka_name ,game_id,matka_id,game_name,is_market_open_nextday,is_market_open_nextday2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("jodifamily_startline", "onCreateView: "+m_id  + "empty"+ starline_id );
...
//                      num = num +Integer.parseInt (String.valueOf (list.get (n)));
                    ...
                    module.addGorupJodi(number,"GROUP JODI",digit,point,"close",list,tableAdaper,list_table,btn_submit,tv_subBid,tv_subAmount,lin_submit);
                    et_digit.requestFocus();
                    clearData ();

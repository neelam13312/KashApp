...
public class BaseUrls {
    ...
    public static final String URL_INDEX=BASE_URL+"getIndex"; ///done
    ...
    public static final String URL_GET_WALLET_AMOUNT=BASE_URL+"getWalletAmount"; ///done
    public static final String URL_Matka=BASE_URL+"getMatkas";///done
    public static final String URL_MENU = BASE_URL+"get_menu";// no need static manage
    public static final String URL_STARLINE=BASE_URL+"getStarline";///done
    //get_starline

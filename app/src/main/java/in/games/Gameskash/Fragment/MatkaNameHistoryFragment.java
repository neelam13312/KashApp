...
import in.games.Gameskash.Adapter.JackpotMatkaAdapter;
import in.games.Gameskash.Adapter.MatkaHistoryAdapter;
import in.games.Gameskash.Adapter.StarlineGameAdapter;
import in.games.Gameskash.Config.Module;
import in.games.Gameskash.Model.MatkahistoryModel;
...
//                            .commit ();
                ...
                intent.putExtra ("matka_id",mList.get(position).getId());

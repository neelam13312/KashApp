...
import static in.games.GamesSattaBets.Config.list_input_data.doublePanna;
import static in.games.GamesSattaBets.Config.list_input_data.singlePaana;
import static in.games.GamesSattaBets.Config.list_input_data.triplePanna;
...
public class PanaFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(name.equalsIgnoreCase ("single panu")){
            ...
            Log.e ("sing", "onCreateView: "+digitlist.size () );
            ...
            Log.e ("doub", "onCreateView: "+digitlist.size () );
            ...
            Log.e ("trip", "onCreateView: "+digitlist.size () );
...
//int m_id= Integer.parseInt(matka_id);
        int  m_id = Integer.parseInt (matka_id);
        Log.e("pana_startline", "onCreateView: "+m_id  + "empty"+ starline_id );
...
//                      num = num +Integer.parseInt (String.valueOf (list.get (n)));
                    ...
                    module.addDataDuplicates(number,name,panna,point,bettype,list,tableAdaper,list_table,btn_submit,tv_subBid,tv_subAmount,lin_submit);

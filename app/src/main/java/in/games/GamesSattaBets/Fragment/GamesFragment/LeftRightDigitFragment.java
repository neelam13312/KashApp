...
public class LeftRightDigitFragment extends Fragment implements View.OnClickListener {
    ...
    Module module;
    String name,betdate,w_amount,market_status;
    Dialog dialog;
    ListView list_table;
    TableAdapter tableAdaper;
    List<TableModel> list;
    List<String> digitlist;
    private String matka_id,e_time,s_time ,matka_name , game_id , game_name ,type = "open" ,game_date="",title="",bet_type="",is_market_open_nextday,is_market_open_nextday2;
    ...
    private void submitData(String dialogType,Dialog dialog) {
            ...
            et_points.requestFocus ( );
             ...
             et_digit.requestFocus ();
                ...
                if (points < min_bet_amount) {
                    ...
                    module.addData (number, game_name, digit, point, bet_type, list, tableAdaper, list_table, btn_submit,tv_subBid,tv_subAmount,lin_submit);

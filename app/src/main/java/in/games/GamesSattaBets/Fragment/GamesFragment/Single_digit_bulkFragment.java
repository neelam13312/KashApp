...
import in.games.GamesSattaBets.Adapter.SingleDigitNumberAdpter;
...
public class Single_digit_bulkFragment extends Fragment implements View.OnClickListener {
    ...
    String name="Single Digit Bulk",betdate,bettype,w_amount="",game_name, matka_name, matka_id ,game_id,s_time ,e_time,no,title,is_market_open_nextday,is_market_open_nextday2;
    Module module;

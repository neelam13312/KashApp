...
import in.games.GamesSattaBets.Adapter.JackpotAdapter;
import in.games.GamesSattaBets.Config.Module;
import in.games.GamesSattaBets.Model.JackpotModel;
...
import static in.games.GamesSattaBets.Config.BaseUrls.URL_JackpotMatka;
...
//                }else {
//
//                    Fragment fm  = new SelectGameActivity ();
...
//                }
                ...
                intent.putExtra("matka_name",model.getName ());
                intent.putExtra ("m_id",model.getId ());
                intent.putExtra("s_num","");
                intent.putExtra("num","");
                intent.putExtra("e_num","");
...
if((object.getString("name").equals ("SIngle Ghar"))){
    list.add(gameRateModel);
    tv_jodi.setText ("SIngle Ghar"+(object.getString("jackpot_rate")));
}

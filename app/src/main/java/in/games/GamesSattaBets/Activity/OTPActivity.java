...
import static in.games.GamesSattaBets.Activity.SplashActivity.msg_status;
import static in.games.GamesSattaBets.Config.BaseUrls.CREATE_MPIN;
import static in.games.GamesSattaBets.Config.BaseUrls.VERIFY_CREATE_MPIN;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (res.equalsIgnoreCase ("success")) {
                        loadingBar.dismiss();
//                        module.successToast(jsonObject.getString("message"));
                            Intent intent = new Intent(OTPActivity.this,MpinLoginActivity.class);

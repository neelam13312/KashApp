...
import in.games.GamesSattaBets.Model.AllHistoryModel;
...
//holder.txt_matka_name.setText (model.getName ());
        ...
        if (model.getStatus().equals("pending"))
        {
            ...
            holder.bid_status.setTextColor(context.getResources().getColor(R.color.dark_orangr));
            holder.bid_status.setCompoundDrawableTintList(context.getResources().getColorStateList(R.color.dark_orangr));
            holder.bid_status.setCompoundDrawablesWithIntrinsicBounds(R.drawable.icons8_neutral_16px,0,0,0);
        }
        else if(model.getStatus().equals("won")||model.getStatus().equals("win"))
        {
            holder.bid_status.setText("You won the bid");
            holder.bid_status.setTextColor(context.getResources().getColor(R.color.green));
            holder.bid_status.setCompoundDrawableTintList(context.getResources().getColorStateList(R.color.green));
            holder.bid_status.setCompoundDrawablesWithIntrinsicBounds(R.drawable.icons8_happy_16px,0,0,0);
        }
        else if(model.getStatus().equals("loss"))
        {  holder.bid_status.setText("You Lost the bid");
            holder.bid_status.setTextColor(context.getResources().getColor(R.color.lightRed));
            holder.bid_status.setCompoundDrawableTintList(context.getResources().getColorStateList(R.color.lightRed));
            holder.bid_status.setCompoundDrawablesWithIntrinsicBounds(R.drawable.icons8_sad_16px,0,0,0);
        }
